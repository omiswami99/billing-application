...
require "conn.php";
	...
	$currentstartmonth = date($year."-01-01 0:0:0");
	$currentendmonth = date($year."-12-31 23:59:59");
...
if($result->num_rows > 0){
	...
	echo '<div style="color: #666" class="mb-3"><span class="h5">ANNUAL REPORT OF '.$year.'</span></div>';
	$output = 
