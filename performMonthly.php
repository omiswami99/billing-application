...
require "conn.php";
   ...
   //Fetching The Year and Month From monthlyreport.php
	...
	$currentstartmonth = date("".$year."-".$month."-01 0:0:0");
	$currentendmonth = date("".$year."-".$month."-31 23:59:59");
...
if($result->num_rows > 0){
	...
	echo '<div style="color: #666" class="mb-3"><span class="h5">MONTHLY REPORT OF '.$month.'/'.$year.'</span></div>';
	$output = 
